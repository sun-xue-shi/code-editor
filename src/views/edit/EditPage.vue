...
import EditWrapper from '@/views/edit/components/EditWrapper.vue'
import LayerSetting from '@/views/edit/components/LayerSetting.vue'
import GroupProps from '@/views/edit/components/GroupProps.vue'
import PropsTable from '@/views/edit/components/PropsTable.vue'
import HistoryOperate from './components/HistoryOperate.vue'
